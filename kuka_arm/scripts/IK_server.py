...
def handle_calculate_IK(req):
    rospy.loginfo("Received %s poses from the plan" % len(req.poses))
    if len(req.poses) < 1:
	    ...
	    # px,py,pz = end-effector position
            ...
            # 1 -> First calculate Wrist Centre

            # a. Construct R0_6 based on target roll, pitch and yaw angles of end-effector ######

            R0_6_num = R0_6.evalf(subs={r:roll, ya:yaw, p:pitch})


            # b. Calculate wrist centre (WC) based on translation along z-axis from EE location
